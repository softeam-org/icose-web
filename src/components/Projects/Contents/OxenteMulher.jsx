  ...
  return (
    <Project title="Projeto Oxente Mulher">
      <div className="flex flex-col gap-4">
        <p>
          Imagine vidas entrelaçadas em busca de dignidade e igualdade. É aqui que começa
          nossa jornada, um chamado para resgatar a essência e a voz da mulher sergipana que, 
          muitas vezes, é silenciada pela sociedade.
        </p>
        <p>
        ...
        <p>
          Participe desta corrente que acredita na força da mulher, para que o ICOSE junto com seus
          parceiros leve esta semente de esperança e consiga dar visibilidade não só as mulheres da
          periferia, mas também a força e diversidade da mulher em outras regiões do Estado de Sergipe.
        </p>
        <p>
